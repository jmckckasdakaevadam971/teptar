...
«Тептар» (чеч. _тептар_ — родовая летопись) — веб-приложение о родовой структуре
...
_Конец файла. Если чего-то не хватает — спроси у владельца проекта (автор: Adam). Удачи!_
